...
class PageTest extends TestCase
{
    ...
    /** @test */
    public function it_has_autogenerated_parent_from_another_page_model()
    {
        ...
        $this->assertEquals($parent->slug, $page->parent);
    }

    /** @test */
    public function it_has_autogenerated_parent_from_another_page_slug()
    {
        $parent = Page::factory()->create();
        $page = Page::create([
            'title' => 'My nested page',
